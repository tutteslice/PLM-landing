...
// .wrangler/tmp/pages-Unp9PG/functionsWorker-0.35155976370502917.mjs
...
async function onRequest3(context22) {
  ...
  try {
    ...
    return new Response(JSON.stringify({ title: title22, content, sources }), { status: 200, headers: HEADERS3 });
  } catch (e) {
    console.error(e);
...
// .wrangler/tmp/bundle-anwiQS/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-anwiQS/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.35155976370502917.js.map
