...
async function onRequest3(context2) {
  ...
  try {
    ...
    const result = provider === "openai" ? await generateWithOpenAI2(topic, env2) : await generateWithGemini(topic, env2);
...
async function generateWithOpenAI2(topic, env2) {
  ...
  try {
    ...
    return { status: 200, body: { title: title2, content, sources } };
  } catch (error3) {
...
var HEADERS3, OPENAI_PROMPT2, GEMINI_MODEL;
...
// ../.wrangler/tmp/bundle-eOJNEj/middleware-loader.entry.ts
init_functionsRoutes_0_40415050906190264();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();

// ../.wrangler/tmp/bundle-eOJNEj/middleware-insertion-facade.js
init_functionsRoutes_0_40415050906190264();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
...
//# sourceMappingURL=functionsWorker-0.3502491602836484.mjs.map
