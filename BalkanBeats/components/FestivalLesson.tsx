...
import { speakCroatian, decodeBase64, decodeAudioData } from '../services/geminiService';

const ALL_PHRASES: LessonPhrase[] = [
  // --- Festival Original ---
  {
    id: 'f1',
    croatian: 'Gdje je glavna pozornica?',
  ...
  {
    id: 'f3',
    croatian: 'Ovo je nevjerojatno!',
    phonetic: 'O-vo je nev-je-ro-jat-no!',
  ...
  {
    id: 'f4',
    croatian: 'Izgubio sam prijatelje.',
  ...
  {
    id: 'h1',
    croatian: 'Gdje mogu ostaviti jaknu?',
  ...
  {
    id: 'h4',
    croatian: 'Tko je zadužen za glazbu?',
    phonetic: 'Tko je za-du-zjen za glaz-bu?',
  ...
  {
    id: 'h5',
    croatian: 'Mogu li napuniti mobitel?',
    phonetic: 'Mo-gu lji na-pu-ni-ti mo-bi-tel?',
  ...
  {
    id: 'h6',
    croatian: 'Hoćemo li naručiti pizzu?',
  ...
  {
    id: 'r5',
    croatian: 'Sviđaju mi se tvoje naočale.',
...
const FestivalLesson: React.FC = () => {
  ...
  const playPhrase = async (phrase: LessonPhrase) => {
    ...
    try {
      ...
      const base64Audio = await speakCroatian(phrase.croatian);
  ...
  return (
    <div className="animate-in fade-in slide-in-from-right-4 duration-700">
      <div className="mb-8 flex flex-col items-center text-center">
        ...
        <p className="text-slate-400 max-w-md">Essential phrases for Croatia's world-class dance music scene.</p>
      </div>
