...
const BalkanBeatsApp: React.FC = () => {
  const [view, setView] = useState<View>('translator');

  return (
    <div className="min-h-screen flex flex-col bg-slate-900">
      {/* Header */}
      <header className="sticky top-0 z-50 bg-gradient-to-r from-purple-600 via-pink-600 to-purple-600 p-4 shadow-xl">
        <div className="container mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="flex items-center gap-3">
            <a href="/" className="flex items-center gap-3 hover:opacity-80 transition-opacity" title="Back to Private Lives Matter">
              ...
              <div>
                <h1 className="text-2xl font-black tracking-tighter text-white">BALKAN BEATS</h1>
      ...
      <footer className="py-6 text-center text-slate-500 text-sm border-t border-slate-800">
        <p>© 2024 Balkan Beats • Built for the dancefloor</p>
        <p className="mt-3">
          <a href="/" className="inline-flex items-center gap-2 px-4 py-2 bg-purple-600/20 hover:bg-purple-600/30 text-purple-300 hover:text-purple-200 rounded-full transition-all font-semibold">
